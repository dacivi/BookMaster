...
<body class="h-screen library-bg">
    <div class="flex items-center justify-center h-full w-full bg-black/50">
        <div class="bg-gray-900/80 p-8 rounded-lg shadow-xl w-full max-w-md text-center backdrop-blur">
            ...
            <form class="space-y-6" method="post" action="/Bookmaster/index.php?view=login&action=login">
                <div class="relative">
                ...
                <div>
                    <button type="submit" name="login" class="w-full bg-gray-800 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded-md transition duration-300">
                        LOGIN
                    </button>
                </div>

                <div class="text-gray-400 text-sm mt-4">
                    ¿No tienes cuenta? <a href="/Bookmaster/index.php?view=register" class="text-blue-500 hover:underline">Registrate aqui</a>
                </div>
